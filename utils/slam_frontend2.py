...
class FrontEnd(mp.Process):
    ...
    def is_keyframe(
        ...
        if cur_frame_idx % 8 == 0  or cur_frame_idx == 720: #584:# or cur_frame_idx ==832 :
            print("key fraaaaame~!")
            return True
        else :
            return False
    ...
    def is_new_submap(
        ...
        if(cur_frame_idx == 720): #584):# or cur_frame_idx == 832):
            return True      
            ...
            if self.frontend_queue.empty():
                ...
                if create_kf:
                    ...
                    if(create_new_submap):
                        ...
                        # depth_map = self.add_new_keyframe(cur_frame_idx, viewpoint, init=False)
