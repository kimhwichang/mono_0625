...
def eval_ate(submap_list, sub_, save_dir, iterations, final=False, monocular=False):
    trj_data = dict()
...
def eval_rendering(
    ...
    for idx in range(begin_idx, end_idx, interval):
        ...
        if(iteration=="before_opt"):
            image_name = "/workspace/MonoGS/aaa/frame_%i.png"%idx 
        if(iteration=="final"):
            image_name = "/workspace/MonoGS/gg/frame_%i.png"%idx 
